...
<body>
	...
	<div class="card " style="border-radius: 10px; width: 85rem;">
		...
		<table class="table">
			<caption class="caption-top">Conference Details</caption>
				...
				<c:forEach items="${conList}" var="m">
					<tbody>
						<tr>
							...
							<td scope="row"><a href="manuscript?email=${email}&conId=${m.getConId()}"><button
										type="button" class="btn btn-light">Submit Paper</button></a></td>
						</tr>
					<tbody>
				</c:forEach>
		</table>
